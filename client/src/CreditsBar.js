...
export default () => (
  <div className={style.container}>
    ...
    <span>Definitions, characters, and pinyin from <Link href="https://cc-cedict.org">CC-CEDICT</Link> (<Link href="https://creativecommons.org/licenses/by-sa/3.0/legalcode">CC BY-SA 3.0</Link>)</span>
    <span>Icons by <Link href="https://www.flaticon.com/authors/egor-rumyantsev">Egor Rumyantsev</Link>, <Link href="https://www.flaticon.com/authors/dave-gandy">Dave Gandy</Link> and <Link href="https://www.freepik.com/">Freepik</Link></span>
